...
/// https://lurkerablog.files.wordpress.com/2014/03/screen-shot-2014-03-25-at-1-08-59-pm.png
/// used the defending pokemon side of the chart
/// </summary>
public class PokemonDamageMultipliers : MonoBehaviour
{
    ...
    private dmgMult dark;
    private dmgMult flying;
    private dmgMult ghost;
    private dmgMult ice;
    private dmgMult rock;
    private dmgMult steel;
    ...
    private dmgMult multiplyTypes(dmgMult t1, dmgMult t2)
    {
    ...
    private dmgMult getSingleType(string t)
    {
        dmgMult type;
        switch (t)
        {
            case TypesStrings.Bug:
                type = bug;
                break;
            case TypesStrings.Dark:
                type = dark;
                break;

            case TypesStrings.Dragon:
                type = dragon;
                break;

            case TypesStrings.Electric:
                type = electric;
                break;

            case TypesStrings.Fairy:
                type = fairy;
                break;

            case TypesStrings.Fighting:
                type = fighting;
                break;

            case TypesStrings.Fire:
                type = fire;
                break;

            case TypesStrings.Flying:
                type = flying;
                break;
            ...
            case TypesStrings.Ice:
                type = ice;
                break;

            case TypesStrings.Normal:
                type = normal;
                break;
            case TypesStrings.Poison:
                type = poison;
                break;

            case TypesStrings.Psychic:
                type = psychic;
                break;

            case TypesStrings.Rock:
                type = rock;
                break;

            case TypesStrings.Steel:
                type = steel;
                break;
